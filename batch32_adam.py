...
Original file is located at
    https://colab.research.google.com/drive/1etepDdHFlqqjU3khfPu9_70dQ7n9Rllb
"""
...
with open('/content/drive/MyDrive/batch32_adam/opt_state.bin', 'wb') as f:
    pickle.dump(opt_state_pickle, f)

with open('/content/drive/MyDrive/batch32_adam/tangent_kernels.bin', 'wb') as f:
    pickle.dump(tangent_kernels, f)

with open('/content/drive/MyDrive/batch32_adam/path_kernels.bin', 'wb') as f:
    pickle.dump(path_kernels, f)

with open('/content/drive/MyDrive/batch32_adam/train_losses.bin', 'wb') as f:
    pickle.dump(train_losses, f)

with open('/content/drive/MyDrive/batch32_adam/kernel_alignments.bin', 'wb') as f:
    pickle.dump(kernel_alignments, f)

with open('/content/drive/MyDrive/batch32_adam/kernel_distances.bin', 'wb') as f:
    pickle.dump(kernel_distances, f)

with open('/content/drive/MyDrive/batch32_adam/kernel_distances_perturbations.bin', 'wb') as f:
    pickle.dump(kernel_distances_perturbations, f)

with open('/content/drive/MyDrive/batch32_adam/kernel_perturbations.bin', 'wb') as f:
    pickle.dump(kernel_perturbations, f)

with open('/content/drive/MyDrive/batch32_adam/training_steps_acumulate.bin', 'wb') as f:
    pickle.dump(training_steps_accumulate, f)

with open('/content/drive/MyDrive/batch32_adam/train_data.bin', 'wb') as f:
  pickle.dump(train_data, f)

with open('/content/drive/MyDrive/batch32_adam/train_labels.bin', 'wb') as f:
...
#read data
opt_state = optimizers.pack_optimizer_state(pickle.load(open('/content/drive/MyDrive/batch32_adamopt_state.bin', 'rb')))
tangent_kernels = pickle.load(open('/content/drive/MyDrive/batch32_adam/tangent_kernels.bin', 'rb'))
train_losses = pickle.load(open('/content/drive/MyDrive/batch32_adam/train_losses.bin', 'rb'))
path_kernels = pickle.load(open('/content/drive/MyDrive/batch32_adam/path_kernels.bin', 'rb'))
kernel_alignments = pickle.load(open('/content/drive/MyDrive/batch32_adam/kernel_alignments.bin', 'rb'))
kernel_distances = pickle.load(open('/content/drive/MyDrive/batch32_adam/kernel_distances.bin', 'rb'))
kernel_distances_perturbations = pickle.load(open('/content/drive/MyDrive/batch32_adam/kernel_distances_perturbations.bin', 'rb'))
kernel_perturbations = pickle.load(open('/content/drive/MyDrive/batch32_adam/kernel_perturbations.bin', 'rb'))
training_steps_accumulate = pickle.load(open('/content/drive/MyDrive/batch32_adam/training_steps_acumulate.bin', 'rb'))
train_data = pickle.load(open('/content/drive/MyDrive/batch32_adam/train_data.bin', 'rb'))
train_labels = pickle.load(open('/content/drive/MyDrive/batch32_adam/train_labels.bin', 'rb'))
