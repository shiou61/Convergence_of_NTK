...
Original file is located at
    https://colab.research.google.com/drive/1Rl_dTLq9PuNYARe2BpiSjhg7vf95smvz
"""
...
for t in time_epochwise:
  kernel_alignments_epochwise.append(kernel_alignments_temp[int(t)])
  train_losses_epochwise.append(train_losses[int(t)])
  kernel_distances_epochwise.append(kernel_distances_temp[int(t)])
  kernel_perturbation_distances_epochwise.append(kernel_perturbations_distances_temp[int(t)])
...
for t in time_epochwise_perturbation:
  kernel_perturbations_epochwise.append(kernel_perturbations_temp[int(t)])
...
ax1.plot(range(training_steps_accumulate), kernel_distances_temp, color="green", label="Kernel Distance")
...
kernel_distance_square = []

for kernel_distance in kernel_distances:
  kernel_distance_square.append(jnp.sqrt(kernel_distance))

#Kernel Distance
fig, ax1= plt.subplots()
ax2 = ax1.twinx()

ax1.plot(range(training_steps_accumulate), kernel_distance_square, color="green", label="Kernel Distance")
...
with open('/content/drive/MyDrive/batch64_adam2/opt_state.bin', 'wb') as f:
    pickle.dump(opt_state_pickle, f)

with open('/content/drive/MyDrive/batch64_adam2/tangent_kernels.bin', 'wb') as f:
    pickle.dump(tangent_kernels, f)

with open('/content/drive/MyDrive/batch64_adam2/path_kernels.bin', 'wb') as f:
    pickle.dump(path_kernels, f)

with open('/content/drive/MyDrive/batch64_adam2/train_losses.bin', 'wb') as f:
    pickle.dump(train_losses, f)

with open('/content/drive/MyDrive/batch64_adam2/kernel_alignments.bin', 'wb') as f:
    pickle.dump(kernel_alignments, f)

with open('/content/drive/MyDrive/batch64_adam2/kernel_distances.bin', 'wb') as f:
    pickle.dump(kernel_distances, f)

with open('/content/drive/MyDrive/batch64_adam2/kernel_distances_perturbations.bin', 'wb') as f:
    pickle.dump(kernel_distances_perturbations, f)

with open('/content/drive/MyDrive/batch64_adam2/kernel_perturbations.bin', 'wb') as f:
    pickle.dump(kernel_perturbations, f)

with open('/content/drive/MyDrive/batch64_adam2/training_steps_acumulate.bin', 'wb') as f:
    pickle.dump(training_steps_accumulate, f)

with open('/content/drive/MyDrive/batch64_adam2/train_data.bin', 'wb') as f:
  pickle.dump(train_data, f)

with open('/content/drive/MyDrive/batch64_adam2/train_labels.bin', 'wb') as f:
  pickle.dump(train_labels, f)

2#read data
opt_state = optimizers.pack_optimizer_state(pickle.load(open('/content/drive/MyDrive/batch64_adam/opt_state.bin', 'rb')))
tangent_kernels = pickle.load(open('/content/drive/MyDrive/batch64_adam2/tangent_kernels.bin', 'rb'))
train_losses = pickle.load(open('/content/drive/MyDrive/batch64_adam2/train_losses.bin', 'rb'))
path_kernels = pickle.load(open('/content/drive/MyDrive/batch64_adam2/path_kernels.bin', 'rb'))
kernel_alignments = pickle.load(open('/content/drive/MyDrive/batch64_adam2/kernel_alignments.bin', 'rb'))
kernel_distances = pickle.load(open('/content/drive/MyDrive/batch64_adam2/kernel_distances.bin', 'rb'))
kernel_distances_perturbations = pickle.load(open('/content/drive/MyDrive/batch64_adam2/kernel_distances_perturbations.bin', 'rb'))
kernel_perturbations = pickle.load(open('/content/drive/MyDrive/batch64_adam2/kernel_perturbations.bin', 'rb'))
training_steps_accumulate = pickle.load(open('/content/drive/MyDrive/batch64_adam2/training_steps_acumulate.bin', 'rb'))
train_data = pickle.load(open('/content/drive/MyDrive/batch64_adam2/train_data.bin', 'rb'))
train_labels = pickle.load(open('/content/drive/MyDrive/batch64_adam2/train_labels.bin', 'rb'))
